...
if (form) {
    form.addEventListener("submit", (e) => {
        ...
        // Target the submit button to handle visual feedback state
        ...
        // Dispatches the form inputs straight to your dashboard template configuration
        emailjs.sendForm('service_319q58r', 'template_zd4j4ah', form)
            .then(() => {
            ...
            .finally(() => {
                // Return button to its active state
...
// ==========================================
// EMAILJS INTEGRATION FOR POPUP FORM
// ==========================================
...
if (popupForm) {
    popupForm.addEventListener("submit", (e) => {
        ...
        emailjs.sendForm('service_319q58r', 'template_zd4j4ah', popupForm)
            .then(() => {
                alert("Booking request sent successfully! The Ghangaria Inn team will contact you shortly.");
                popupForm.reset();
                closeModal(); // Closes modal automatically after success
            }, (error) => {
                alert("Oops... Something went wrong. Please try again or reach out to us directly via WhatsApp.");
                console.error('EmailJS Error:', error);
            })
